...
# ==============================================================================
"""Analyze function call stack from GDB or Renode"""
import argparse
import collections
import json
import os
...
def gdb_log_parser(data, output, ignore_list=None, full_trace=False):
  """
  Args:
  ...
  """
  regex_parser = load_regex_parser("./src/regex.json")
...
def parse_log(filename,
  ...
  if source == "gdb":
    gdb_log_parser(data, output, ignore_list, full_trace)
  elif source == "renode":
...
if __name__ == "__main__":
  ...
  parse_log(args.input, args.output, args.source, args.ignore,
        args.full_trace)
